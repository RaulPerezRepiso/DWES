...
class Acceso
{
    ...
    {
        if (!isset($_SESSION))
            return false; //no hay sesion devuelve false
        ...
        if ($this->_validado) {
            ...
            return true; //datos guardados devuelve true
        } else {
            $_SESSION["acceso"]["validado"] = false;
            return false; //no validado devuelve false
        }
    }
    ...
    {
        if ($this->hayUsuario()) { //comprobamos que el usuario esta validado
            return $this->_permisos[$numero]; //comprobamos el permiso
        } else {
            return false;
        }
    }
    ...
    {
        if ($this->_nick != "") { //si no hay nick no hay usuario
            return $this->_nick;
        } else {
            return false;
        }
