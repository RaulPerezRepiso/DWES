...
class ACLArray extends ACLBase
{
    ...
    {
        // Añadir los roles (Tendremos que darle todos los roles para después poder comprobarlos todos bien)    
        $this->anadirRole("usuario", [1 => true]);
        $this->anadirRole("comprador", [1 => true, 2 => true, 3 => true, 4 => true, 5 => true, 6 => true, 7 => true,  8 => true]);
        $this->anadirRole("administrativo", [1 => true, 2 => true, 3 => true, 4 => true, 5 => true, 6 => true, 7 => true, 8 => true, 9 => true]);
        $this->anadirRole("administrador", [1 => true, 2 => true, 3 => true, 4 => true, 5 => true, 6 => true, 7 => true,8 => true, 9 => true, 10 => true]);

        // Añadir los usuarios con su rol correspondinte dependiendo del tipo de usuario
        $this->anadirUsuario("Usuario", "usu", "1234", $this->getCodRole("usuario"));
        $this->anadirUsuario("Comprador", "comp", "1234", $this->getCodRole("comprador"));
        $this->anadirUsuario("Administrativo", "admin", "1234", $this->getCodRole("administrativo"));
        $this->anadirUsuario("Raúl Pérez (ADM)", "raul", "1234", $this->getCodRole("administrador"));
    }
